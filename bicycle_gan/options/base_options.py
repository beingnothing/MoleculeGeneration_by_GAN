...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--input_nc', type=int, default=7, help='# of input image channels')
        parser.add_argument('--output_nc', type=int, default=5, help='# of output image channels')
        parser.add_argument('--nz', type=int, default=7, help='#latent vector')
        parser.add_argument('--gpu_ids', type=str, default='1', help='gpu ids: e.g. 0  0,1,2, 0,2, -1 for CPU mode')
        parser.add_argument('--name', type=str, default='DUDE', help='name of the experiment. It decides where to store samples and models')
